...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top" style="float: left;">
  ...
  <ul class="navbar-nav">
    ...
    <!-- CODE FOR SEARCH BOX/BAR -->
     <form class="form-inline" action="results.php" enctype="multipart/form-data" style="float: right;">
...
<div class="row">
 ...
 <!-- ITEMS BRANDS AS A LIST GROUP -->
    ...
    <div class="col-sm-10" style="background-color:skyblue;">
      ...
      <div style="width: 80%; height: 5%; background: black; color: white;">
...
<?php echo"YA IP Address is".$ip=getIp(); ?>
      <div id="products_box">
        ...
        // PHP CODE TO SEARCH FOR A PRODUCT FROM THE DATABASE AND DISPLAY IT ON THE WEBSITE. THE SEARCH WORDS INPUTTED BY THE USER IS COMPARED AGAINST THE SPECIFIED KEYWORDS AND IF ANY KEYWORD MATCHES THE SEARCHED WORDS, THE PRODUCTS ARE DISPLAYED
        $get_pro = "SELECT * FROM products WHERE product_keywords LIKE 
        '%$search_query%'";

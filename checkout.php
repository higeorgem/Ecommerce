...
<?php echo"YA IP Address is".$ip=getIp(); ?>
      <div id="products_box">
         <?php
         // IF THE CUSTOMER EMAIL IS NOT REGISTRED AS SESSION/CUSTOMER IS NOT ALREADY LOGGED IN INCLUDE/DISPLAY A LOGIN PAGE 
         if (!isset($_SESSION['customer_email'])) {
           include("customer_login.php");
         }
         // OTHERWISE IF THE CUSTOMER IS ALREADY LOGGED IN OR CUSTOMER EMAIL IS REGISTERED AS SESSION DISPLAY PAYMENT METHOD
         else{
          include("payment.php");
         }
         ?>
         ...
         <!-- 
          ...
          <!-- <form style="width: 40%; columns: scroll;">
            <marquee style="margin-left: 15%; color: green;"> Thak You For Shopping With Us</marquee>
            <p>Click <a href="higeorgem@gmail.com">here</a> to recieve our weekly newsletter</p>
          </form> -->
      </div>
    </div>
  </div>

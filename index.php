...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top" style="float: left; @media screen and (max-width: 580px) {
  #navbar {
...
<?php echo"IP Address is".$ip=getIp(); ?>
      <div id="products_box">
        <?php getPro(); ?><!--THIS FUNCTION IS BEING CALLED TO DISPLAY 8 RANDOM PRODUCTS-->
        <?php getCatPro(); ?><!--THIS FUNCTION IS CALLED WHEN A PARTICULAR CATEGORY IS SELECTED TO DISPLAY ALL PRODUCTS(8 RANDOM PRODUCTS)BELONGING TO THE SELECTED CATEGORY-->
        <?php getBrandPro(); ?><!--THIS FUNCTION IS CALLED WHEN A PARTICULAR BRAND IS SELECTED TO DISPLAY ALL PRODUCTS(8 RANDOM PRODUCTS) BELONGING TO THE SELECTED BRAND-->
      </div>
    </div>
  </div>

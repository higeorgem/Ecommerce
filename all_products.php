 ...
 <!-- ITEMS BRANDS AS A LIST GROUP -->
    ...
    <div class="col-sm-10" style="background-color:skyblue;">
      ...
      <div style="width: 80%; height: 5%; background: black; color: white;">
        <span style="float: right; font-size: 18dp; padding: 5dp; line-height: 4e0dp; margin-left: 0.5%;">
          <?php 
